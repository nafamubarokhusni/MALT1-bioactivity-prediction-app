...
def desc_calc():
    ...
    bashCommand = "java -Xms2G -Xmx2G -Djava.awt.headless=true -jar https://github.com/nafamubarokhusni/MALT1-bioactivity-prediction-app/tree/master/PaDEL-Descriptor/PaDEL-Descriptor/PaDEL-Descriptor.jar -removesalt -standardizenitro -fingerprints -descriptortypes ./PaDEL-Descriptor/PubchemFingerprinter.xml -dir ./ -file descriptors_output.csv"
...
def build_model(input_data):
    ...
    load_model = pickle.load(open('MALT1_model.pkl', 'rb'))
...
# Page title
st.markdown("""
# Bioactivity Prediction App (MALT1)
## Daftar Anggota
